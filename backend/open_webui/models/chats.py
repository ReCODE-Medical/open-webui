...
from open_webui.internal.db import Base, get_db, get_supabase_db, init_supa_table
...
class ChatTable:
    ...
    def insert_new_chat(self, user_id: str, form_data: ChatForm) -> Optional[ChatModel]:
        from open_webui.models.users import Users  # Lazy import to avoid circular imports
    ...
    def update_shared_chat_by_chat_id(self, chat_id: str) -> Optional[ChatModel]:
        try:
            with get_db() as db:
                ...
                shared_chat.oauth_sub = chat.oauth_sub
