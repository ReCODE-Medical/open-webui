...
from open_webui.internal.db import Base, JSONField, get_db, get_supabase_db, init_supa_table
        ...
        try:
            with get_db() as db:
                ...
                def supa_update():
                    try:
                        with get_supabase_db() as supabase_db:
                            supabase_db.query(User).filter_by(id=id).update({"role": role})
                            supabase_db.commit()
                    except Exception as e:
        ...
        try:
            with get_db() as db:
                ...
                def supa_update():
                    try:
                        with get_supabase_db() as supabase_db:
                            supabase_db.query(User).filter_by(id=id).update(
                                {"profile_image_url": profile_image_url}
                            )
                            supabase_db.commit()
                    except Exception as e:
        ...
        try:
            with get_db() as db:
                ...
                def supa_update():
                    try:
                        with get_supabase_db() as supabase_db:
                            supabase_db.query(User).filter_by(id=id).update({"oauth_sub": oauth_sub})
                            supabase_db.commit()
                    except Exception as e:
        ...
        try:
            with get_db() as db:
                ...
                def supa_update():
                    try:
                        with get_supabase_db() as supabase_db:
                            supabase_db.query(User).filter_by(id=id).update(updated)
                            supabase_db.commit()
                    except Exception as e:
            ...
            if result:
                with get_db() as db:
                    ...
                    def supa_delete():
                        try:
                            with get_supabase_db() as supabase_db:
                                supabase_db.query(User).filter_by(id=id).delete()
                                supabase_db.commit()
                        except Exception as e:
        ...
        try:
            with get_db() as db:
                ...
                def supa_update():
                    try:
                        with get_supabase_db() as supabase_db:
                            supabase_db.query(User).filter_by(id=id).update({"api_key": api_key})
                            supabase_db.commit()
                    except Exception as e:
